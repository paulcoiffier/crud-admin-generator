...
$console
    ...
    ->setCode(function (InputInterface $input, OutputInterface $output) use ($app) {
        ...
        foreach ($tables as $table_name => $table) {
            ...
            $table_columns_names = $table['columns'];

            $TABLENAME = $table_name;
            $TABLE_PRIMARYKEY = $table['primary_key'];

            $TABLECOLUMNS_ARRAY = "";
            $TABLECOLUMNS_ARRAY_NAMES = "";
            ...
            if ($lang == "en") {
                $MENU_OPTIONS .= "        <li {% if option is defined and option == '" . $TABLENAME . "_list' %}class=\"active\"{% endif %}><a href=\"{{ path('" . $TABLENAME . "_list') }}\" style=\"margin-left: 10px;\"><i class=\"fa fa-angle-double-right\"></i> List</a></li>" . "\n" .
                ...
                $MENU_OPTIONS .= "        <li {% if option is defined and option == '" . $TABLENAME . "_list' %}class=\"active\"{% endif %}><a href=\"{{ path('" . $TABLENAME . "_list') }}\" style=\"margin-left: 10px;\"><i class=\"fa fa-angle-double-right\"></i> Liste</a></li>" . "\n" .
            ...
            foreach ($table_columns as $table_column) {
                ...
                $TABLECOLUMNS_ARRAY_NAMES .= "\t\t" . "'" . $table_column['comment'] . "', \n";
            ...
            // Add for columns names
            $_controller = str_replace("__TABLECOLUMNS_NAMES_ARRAY__", $TABLECOLUMNS_ARRAY_NAMES, $_controller);
            ...
            $_create_template = file_get_contents(__DIR__ . '/../gen/views/' . $lang . '/create.html.twig');
            ...
            $_edit_template = file_get_contents(__DIR__ . '/../gen/views/' . $lang . '/edit.html.twig');
            ...
            $_menu_template = file_get_contents(__DIR__ . '/../gen/views/' . $lang . '/menu.html.twig');
